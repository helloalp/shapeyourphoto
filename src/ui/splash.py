...
class SplashScreen:
    def __init__(self, root: tk.Tk, *, min_ms: int = 900, message: str | None = None) -> None:
        self.root = root
        ...
        tk.Label(outer, text=message or "ShapeYourPhoto", bg="#f7faf8", fg="#17361f", font=("Segoe UI", 18, "bold")).pack()
