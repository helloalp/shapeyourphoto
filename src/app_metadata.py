    ...
    "en_US": [
        {
            ...
            "items": [
                ...
                "GPU status now explains the difference between detected hardware and missing Python/CUDA runtime backends, with an optional dependency file for backend validation.",
    ...
    "ja_JP": [
        {
            ...
            "items": [
                ...
                "GPU 状態では、検出されたハードウェアと Python/CUDA 実行バックエンド不足を区別し、任意の依存ファイルから確認できます。",
...
CHANGELOG: list[dict[str, object]] = [
    ...
    },
    {
        ...
        "items": [
            ...
            "设置页新增语言偏好保存逻辑；更新页只显示 Shape Your Photo vX.Y.Z 和版本 ID，不再向普通用户展示构建 ID、更新 URL、公告 URL 或自动管理说明。",
    ...
    },
    {
        ...
        "items": [
            ...
            "设置页更新区域只显示当前版本名称和版本 ID，保留手动检查更新按钮，不再向普通用户展示构建 ID。",
