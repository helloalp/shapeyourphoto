...
CHANGELOG: list[dict[str, object]] = [
    ...
    },
    {
        ...
        "items": [
            ...
            "新增 UI display mapping 层，内部英文 code/enum/storage 保持不变，UI 对 issue、scene/portrait/exposure/color、repair method/policy、outcome、worker/GPU/scan/Console 时间模式和 perf stage 做用户语言展示。",
